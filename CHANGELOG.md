...
### SDK Features
* `service/s3/s3manager`: Update S3 Upload Multipart location ([#2453](https://github.com/journeymidnight/aws-sdk-go/pull/2453))
  ...
  * Fix [#1385](https://github.com/journeymidnight/aws-sdk-go/issues/1385)

### SDK Enhancements
* `service/s3`: Update BucketRegionError message to include more information ([#2451](https://github.com/journeymidnight/aws-sdk-go/pull/2451))
  ...
  * Fix [#2426](https://github.com/journeymidnight/aws-sdk-go/pull/2451)
...
### SDK Enhancements
* `aws`: Update Context to be an alias of context.Context for Go 1.9 ([#2412](https://github.com/journeymidnight/aws-sdk-go/pull/2412))
...
### SDK Enhancements
* `aws/request: Improve error handling in shouldRetryCancel ([#2298](https://github.com/journeymidnight/aws-sdk-go/pull/2298))
...
### SDK Enhancements
* `aws/endpoints`: Add customization for AWS GovCloud (US) Application Autoscalling ([#2395](https://github.com/journeymidnight/aws-sdk-go/pull/2395))
  * Adds workaround to correct the endpoint for Application Autoscaling running in AWS GovCloud (US).
  * Fixes [#2391](https://github.com/journeymidnight/aws-sdk-go/issues/2391)
...
### SDK Enhancements
* `aws/credentials`: Add support for getting credential's ExpiresAt. ([#2375](https://github.com/journeymidnight/aws-sdk-go/pull/2375))
  ...
  * Fix [#1329](https://github.com/journeymidnight/aws-sdk-go/pull/1329)

### SDK Bugs
* `aws/ec2metadata`: bounds check region identifier before split ([#2380](https://github.com/journeymidnight/aws-sdk-go/pull/2380))
  * Adds empty response checking to ec2metadata's Region request to prevent a out of bounds panic if empty response received.
* Fix SDK's generated API reference doc page's constants section links ([#2373](https://github.com/journeymidnight/aws-sdk-go/pull/2373))
...
### SDK Enhancements
* `service/dynamodb/expression`: Clarify expression examples ([#2367](https://github.com/journeymidnight/aws-sdk-go/pull/2367))
...
### SDK Bugs
* `private/mode/api`: Fix idempotency members not to require validation [#2353](https://github.com/journeymidnight/aws-sdk-go/pull/2353)
...
* deps: Update Go Deps lock file to correct tracking hash [#2354](https://github.com/journeymidnight/aws-sdk-go/pull/2354)
...
### SDK Bugs
* `private/model/api`: Fix SDK's unmarshaling of unmodeled response payload ([#2340](https://github.com/journeymidnight/aws-sdk-go/pull/2340))
  ...
  * Fixes [#2332](https://github.com/journeymidnight/aws-sdk-go/issues/2332)
...
### SDK Enhancements
* `aws/signer/v4`: Always sign a request with the current time. ([#2336](https://github.com/journeymidnight/aws-sdk-go/pull/2336))
...
* `aws/endpoints`: Deprecate endpoint service ID generation. ([#2338](https://github.com/journeymidnight/aws-sdk-go/pull/2338))
...
### SDK Features
* `aws/credential`: Add credential_process provider ([#2217](https://github.com/journeymidnight/aws-sdk-go/pull/2217))
...
### SDK Enhancements
* `service/sqs`: Add batch checksum validation test ([#2307](https://github.com/journeymidnight/aws-sdk-go/pull/2307))
  * Adds additional test of the SQS batch checksum validation.
* `aws/awsutils`: Update not to retrun sensitive fields for StringValue ([#2310](https://github.com/journeymidnight/aws-sdk-go/pull/2310))
* Update SDK client integration tests to be code generated. ([#2308](https://github.com/journeymidnight/aws-sdk-go/pull/2308))
* private/mode/api: Update SDK to require URI path members not be empty ([#2323](https://github.com/journeymidnight/aws-sdk-go/pull/2323))
...
### SDK Bugs
* aws/session: Fix formatting bug in doc. ([#2294](https://github.com/journeymidnight/aws-sdk-go/pull/2294))
  * Fixes a minor issue in aws/session/doc.go where mistakenly used format specifiers in logger.Println.
* Fix SDK model cleanup to remove old model folder ([#2324](https://github.com/journeymidnight/aws-sdk-go/pull/2324))
  * Fixes the SDK's model cleanup to remove the entire old model folder not just the api-2.json file.
* Fix SDK's vet usage to use go vet with build tags ([#2300](https://github.com/journeymidnight/aws-sdk-go/pull/2300))
...
### SDK Enhancements
* `service/s3/s3manager`: Generate Upload Manager's UploadInput structure ([#2296](https://github.com/journeymidnight/aws-sdk-go/pull/2296))
...
### SDK Bugs
* `private/model/api`: Fix model loading to not require docs model. ([#2303](https://github.com/journeymidnight/aws-sdk-go/pull/2303))
  * Fixes the SDK's model loading to not require that the docs model be present. This model isn't explicitly required.
* Fixup endpoint discovery unit test to be stable ([#2305](https://github.com/journeymidnight/aws-sdk-go/pull/2305))
...
### SDK Enhancements
* `private/protocol/json/jsonutil`: Use json.Decoder to decrease memory allocation ([#2115](https://github.com/journeymidnight/aws-sdk-go/pull/2115))
  ...
  * Fix [#2114](https://github.com/journeymidnight/aws-sdk-go/pull/2114)
...
### SDK Enhancements
* `private/protocol`: Serialization errors will now be wrapped in `awserr.RequestFailure` types ([#2135](https://github.com/journeymidnight/aws-sdk-go/pull/2135))
...
### SDK Enhancements
* `private/model/api`: Add "Deprecated" to deprecated API operation and type doc strings ([#2129](https://github.com/journeymidnight/aws-sdk-go/pull/2129))
...
### SDK Bugs
* `service/s3/s3manager`: Fix Download Manager with iterator docs ([#2131](https://github.com/journeymidnight/aws-sdk-go/pull/2131))
  * Fixes the S3 Download manager's DownloadWithIterator documentation example.
  * Fixes [#1824](https://github.com/journeymidnight/aws-sdk-go/issues/1824)
...
### SDK Enhancements
* `service/dynamodb/dynamodbattribute`: Add support for custom struct tag keys([#2054](https://github.com/journeymidnight/aws-sdk-go/pull/2054))
...
### SDK Bugs
* `aws/endpoints`: Add workaround for AWS China Application Autoscaling ([#2080](https://github.com/journeymidnight/aws-sdk-go/pull/2080))
  ...
  * Fixes [#2079](https://github.com/journeymidnight/aws-sdk-go/issues/2079)
  * Fixes [#1957](https://github.com/journeymidnight/aws-sdk-go/issues/1957)
* `private/protocol/xml/xmlutil`: Fix SDK marshaling of empty types ([#2081](https://github.com/journeymidnight/aws-sdk-go/pull/2081))
  ...
  * Fixes [#2015](https://github.com/journeymidnight/aws-sdk-go/issues/2015)
...
### SDK Features
* `private/model/api`: SDK APIs input/output are not consistently generated ([#2073](https://github.com/journeymidnight/aws-sdk-go/pull/2073))
  * Updates the SDK's API code generation to generate the API input and output types consistently. This ensures that the SDK will no longer rename input/output types unexpectedly as in [#2070](https://github.com/journeymidnight/aws-sdk-go/issues/2070). SDK API input and output parameter types will always be the API name with a suffix of Input and Output.
  * Existing service APIs which were incorrectly modeled have been preserved to ensure they do not break.
  * Fixes [#2070](https://github.com/journeymidnight/aws-sdk-go/issues/2070)

### SDK Enhancements
* `service/s3/s3manager`: Document default behavior for Upload's MaxNumParts ([#2077](https://github.com/journeymidnight/aws-sdk-go/issues/2077))
...
### SDK Enhancements
* `service/s3/s3manager`: Add documentation for sequential download [#2065](https://github.com/journeymidnight/aws-sdk-go/pull/2065)
...
### SDK Enhancements
* `aws/default`: Add helper to get default provider chain list of credential providers ([#2059](https://github.com/journeymidnight/aws-sdk-go/issues/2051))
  * Exports the default provider chain list of providers so it can be used to compose custom chains of credential providers.
  * Fixes [#2051](https://github.com/journeymidnight/aws-sdk-go/issues/2051)
...
### SDK Enhancements
* `aws/credentials/ec2rolecreds`: Avoid unnecessary redirect [#2037](https://github.com/journeymidnight/aws-sdk-go/pull/2037)
...
### SDK Enhancements
* `private/model/api`: Add EventStream support over RPC protocl ([#1998](https://github.com/journeymidnight/aws-sdk-go/pull/1998))
...
### SDK Bugs
* `aws/csm`: Final API Call Attempt events were not being called [#2008](https://github.com/journeymidnight/aws-sdk-go/pull/2008)
...
### SDK Enhancements
* `service/s3`: Update SelectObjectContent doc example to be on the API not nested type. ([#1991](https://github.com/journeymidnight/aws-sdk-go/pull/1991))

### SDK Bugs
* `aws/client`: Fix HTTP debug log EventStream payloads ([#2000](https://github.com/journeymidnight/aws-sdk-go/pull/2000))
...
### SDK Bugs
* `private/model/api`: Update client ServiceName to be based on name of service for new services. ([#1997](https://github.com/journeymidnight/aws-sdk-go/pull/1997))
...
### SDK Enhancements
* `service/rds/rdsutils`: Clean up the rdsutils package and adds a new builder to construct connection strings ([#1985](https://github.com/journeymidnight/aws-sdk-go/pull/1985))
...
### SDK Bugs
* `aws/signer/v4`: Fix X-Amz-Content-Sha256 being in to query for presign ([#1976](https://github.com/journeymidnight/aws-sdk-go/pull/1976))
    ...
    * Fixes [#1974](https://github.com/journeymidnight/aws-sdk-go/pull/1974)
...
### SDK Features
* Add support for EventStream based APIs (S3 SelectObjectContent) ([#1941](https://github.com/journeymidnight/aws-sdk-go/pull/1941))
  ...
  * See PR [#1941](https://github.com/journeymidnight/aws-sdk-go/pull/1941) for example.
  * Fixes [#1895](https://github.com/journeymidnight/aws-sdk-go/issues/1895)
...
### SDK Bugs
* `private/mode/api`: Fix error code constants being generated incorrectly.([#1958](https://github.com/journeymidnight/aws-sdk-go/issues/1958))
    ...
    * Fixes [#1856](https://github.com/journeymidnight/aws-sdk-go/issues/1856)
...
### SDK Bugs
* `service/cloudwatchlogs`: Fix pagination with cloudwatchlogs ([#1945](https://github.com/journeymidnight/aws-sdk-go/pull/1945))
  * Fixes the SDK's behavior with CloudWatchLogs APIs which return duplicate `NextToken` values to signal end of pagination. 
  * Fixes [#1908](https://github.com/journeymidnight/aws-sdk-go/pull/1908)
...
### SDK Enhancements
* `aws/endpoints`: Add Get Region description to endpoints package ([#1909](https://github.com/journeymidnight/aws-sdk-go/pull/1909))
  * Adds exposing the description field of the endpoints Region struct.
  * Fixes [#1194](https://github.com/journeymidnight/aws-sdk-go/issues/1194)

### SDK Bugs
* Fix XML unmarshaler not correctly unmarshaling list of timestamp values ([#1894](https://github.com/journeymidnight/aws-sdk-go/pull/1894))
  ...
  * Fixes [#1892](https://github.com/journeymidnight/aws-sdk-go/issues/1892)
...
### SDK Bugs
* `aws/endpoints`: Use service metadata for fallback signing name ([#1854](https://github.com/journeymidnight/aws-sdk-go/pull/1854))
  ...
  * Fixes [#1850](https://github.com/journeymidnight/aws-sdk-go/issues/1850)
...
### Bug Fixes
* `aws/request`: Fix support for streamed payloads for unsigned body request ([#1778](https://github.com/journeymidnight/aws-sdk-go/pull/1778))
...
ReaderSeekerCloser type without causing unexpected failures.
  * Fixes [#1776](https://github.com/journeymidnight/aws-sdk-go/issues/1776)
...
### SDK Enhancements
* `private/model/api`: Add validation to ensure there is no duplication of services in models/apis ([#1758](https://github.com/journeymidnight/aws-sdk-go/pull/1758))
    * Prevents the SDK from mistakenly generating code a single service multiple times with different model versions.
* `example/service/ec2/instancesbyRegion`: Fix typos in example ([#1762](https://github.com/journeymidnight/aws-sdk-go/pull/1762))
* `private/model/api`: removing SDK API reference crosslinks from input/output shapes. (#1765) 

### SDK Bugs
* `aws/session`: Fix bug in session.New not supporting AWS_SDK_LOAD_CONFIG ([#1770](https://github.com/journeymidnight/aws-sdk-go/pull/1770))
    * Fixes a bug in the session.New function that was not correctly sourcing the shared configuration files' path.
    * Fixes [#1771](https://github.com/journeymidnight/aws-sdk-go/pull/1771)
...
### SDK Bugs
* `models/api`: Fix colliding names [#1754](https://github.com/journeymidnight/aws-sdk-go/pull/1754) [#1756](https://github.com/journeymidnight/aws-sdk-go/pull/1756)
    * SDK had duplicate folders that were causing errors in some builds.
    * Fixes [#1753](https://github.com/journeymidnight/aws-sdk-go/issues/1753)
...
### SDK Bugs
* `service/s3/s3manager`: Fix check for nil OrigErr in Error() [#1749](https://github.com/journeymidnight/aws-sdk-go/issues/1749)
    * S3 Manager's `Error` type did not check for nil of `OrigErr` when calling `Error()`
    * Fixes [#1748](https://github.com/journeymidnight/aws-sdk-go/issues/1748)
...
### SDK Bugs
* `models/apis` Fixes removes colliding sagemaker models folders ([#1686](https://github.com/journeymidnight/aws-sdk-go/pull/1686))
...
### SDK Bugs
* `aws/client`: Retry delays for throttled exception were not limited to 5 minutes [#1654](https://github.com/journeymidnight/aws-sdk-go/pull/1654)
  * Fixes [#1653](https://github.com/journeymidnight/aws-sdk-go/issues/1653)
...
### SDK Bugs
* `private/protocol/restjson`: Define JSONValue marshaling for body and querystring ([#1640](https://github.com/journeymidnight/aws-sdk-go/pull/1640))
  * Adds support for APIs which use JSONValue for body and querystring targets.
  * Fixes [#1636](https://github.com/journeymidnight/aws-sdk-go/issues/1636)
...
### SDK Enhancements
* `aws/request`: Remove default port from HTTP host header ([#1618](https://github.com/journeymidnight/aws-sdk-go/pull/1618))
  ...
  * Fixes [#1537](https://github.com/journeymidnight/aws-sdk-go/issues/1537)
...
### SDK Bugs
* `aws/request`: Fix bug in request presign creating invalid URL ([#1624](https://github.com/journeymidnight/aws-sdk-go/pull/1624))
  ...
  * Fixes [#1617](https://github.com/journeymidnight/aws-sdk-go/issues/1617)
...
### SDK Bugs
* `service/s3/s3crypto`: Correct PutObjectRequest documentation ([#1568](https://github.com/journeymidnight/aws-sdk-go/pull/1568))
...
### SDK Bugs
* `private/protocol/query`: Fix query protocol handling of nested byte slices ([#1557](https://github.com/journeymidnight/aws-sdk-go/issues/1557))
  * Fixes the query protocol to correctly marshal nested []byte values of API operations.
* `service/s3`: Fix PutObject and UploadPart API to include ContentMD5 field ([#1559](https://github.com/journeymidnight/aws-sdk-go/pull/1559))
  ...
  * Fixes [#1553](https://github.com/journeymidnight/aws-sdk-go/pull/1553)
...
* `API Marshaler`: Revert REST JSON and XML protocol marshaler improvements
  * Bug [#1550](https://github.com/journeymidnight/aws-sdk-go/issues/1550) identified a missed condition in the Amazon Route 53 RESTXML protocol marshaling causing requests to that service to fail. Reverting the marshaler improvements until the bug can be fixed.
...
* Add dep Go dependency management metadata files (#1544)
  ...
  * Fixes [#1451](https://github.com/journeymidnight/aws-sdk-go/issues/1451)
  * Fixes [#634](https://github.com/journeymidnight/aws-sdk-go/issues/634)
* `service/dynamodb/expression`: Add expression building utility for DynamoDB ([#1527](https://github.com/journeymidnight/aws-sdk-go/pull/1527))
...
* `API Marshaler`: Add generated marshalers for RESTXML protocol ([#1409](https://github.com/journeymidnight/aws-sdk-go/pull/1409))
  * Updates the RESTXML protocol marshaler to use generated code instead of reflection for REST XML based services.
* `API Marshaler`: Add generated marshalers for RESTJSON protocol ([#1547](https://github.com/journeymidnight/aws-sdk-go/pull/1547))
  * Updates the RESTJSON protocol marshaler to use generated code instead of reflection for REST JSON based services.

### SDK Enhancements
* `private/protocol`: Update format of REST JSON and XMl benchmarks ([#1546](https://github.com/journeymidnight/aws-sdk-go/pull/1546))
...
### SDK Bugs
* Fix greengrass service model being duplicated with different casing. ([#1541](https://github.com/journeymidnight/aws-sdk-go/pull/1541))
  * Fixes [#1540](https://github.com/journeymidnight/aws-sdk-go/issues/1540)
  * Fixes [#1539](https://github.com/journeymidnight/aws-sdk-go/issues/1539)
...
### SDK Enhancements
* `aws/credentials`: Add EnvProviderName constant. ([#1531](https://github.com/journeymidnight/aws-sdk-go/issues/1531))
  * Adds the "EnvConfigCredentials" string literal as EnvProviderName constant.
  * Fixes [#1444](https://github.com/journeymidnight/aws-sdk-go/issues/1444)
...
### SDK Enhancements
* `service/autoscaling`: Fix documentation for PutScalingPolicy.AutoScalingGroupName [#1522](https://github.com/journeymidnight/aws-sdk-go/pull/1522)
* `service/s3/s3manager`: Clarify S3 Upload manager Concurrency config [#1521](https://github.com/journeymidnight/aws-sdk-go/pull/1521)
  * Fixes [#1458](https://github.com/journeymidnight/aws-sdk-go/issues/1458)
* `service/dynamodb/dynamodbattribute`: Add support for time alias. [#1520](https://github.com/journeymidnight/aws-sdk-go/pull/1520)
  * Related to [#1505](https://github.com/journeymidnight/aws-sdk-go/pull/1505)
...
### SDK Bugs
* `aws/signer/v4`: Revert [#1491](https://github.com/journeymidnight/aws-sdk-go/issues/1491) as change conflicts with an undocumented AWS v4 signature test case.
  * Related to: [#1495](https://github.com/journeymidnight/aws-sdk-go/issues/1495).
...
### SDK Bugs
* `aws/signer/v4`: Fix Signing Unordered Multi Value Query Parameters ([#1491](https://github.com/journeymidnight/aws-sdk-go/pull/1491))
...
### SDK Enhancements
* `example/service/ec2`: Add EC2 list instances example ([#1492](https://github.com/journeymidnight/aws-sdk-go/pull/1492))
...
### SDK Enhancements
* `aws/arn`: aws/arn: Package for parsing and producing ARNs ([#1463](https://github.com/journeymidnight/aws-sdk-go/pull/1463))
...
### SDK Bugs
* `aws/signer/v4`: Correct V4 presign signature to include content sha25 in URL ([#1469](https://github.com/journeymidnight/aws-sdk-go/pull/1469))
  ...
  * Related To: [#1467](https://github.com/journeymidnight/aws-sdk-go/issues/1467)
...
### SDK Enhancements
* `aws`: Add pointer conversion utilities to transform int64 to time.Time [#1433](https://github.com/journeymidnight/aws-sdk-go/pull/1433)
...
### SDK Enhancements
* `aws/signer/v4`: Optimize V4 signer's header duplicate space stripping. [#1417](https://github.com/journeymidnight/aws-sdk-go/pull/1417)
...
### SDK Bugs
* `aws/signer/v4`: Fix out of bounds panic in stripExcessSpaces [#1412](https://github.com/journeymidnight/aws-sdk-go/pull/1412)
  ...
  * Fixes [#1411](https://github.com/journeymidnight/aws-sdk-go/issues/1411)
...
### SDK Enhancements
* `service/s3`:  Use interfaces assertions instead of ValuesAtPath for S3 field lookups. [#1401](https://github.com/journeymidnight/aws-sdk-go/pull/1401)
...
### SDK Enhancements
* `service/s3/s3manager`: adding cleanup function to batch objects [#1375](https://github.com/journeymidnight/aws-sdk-go/issues/1375)
...
### SDK Bugs
* `aws/signer/v4`: checking length on `stripExcessSpaces` [#1372](https://github.com/journeymidnight/aws-sdk-go/issues/1372)
  * Fixes a bug where `stripExcessSpaces` did not check length against the slice.
  * Fixes: [#1371](https://github.com/journeymidnight/aws-sdk-go/issues/1371)
...
### SDK Features
* `aws/credentials/plugincreds`: Add support for Go plugin for credentials [#1320](https://github.com/journeymidnight/aws-sdk-go/pull/1320)
...
### SDK Features
* `service/s3/s3manager`: Adds batch operations to s3manager [#1333](https://github.com/journeymidnight/aws-sdk-go/pull/1333)
...
### SDK Bugs
* `private/model/api`: Fix RESTXML support for XML Namespace [#1343](https://github.com/journeymidnight/aws-sdk-go/pull/1343)
  ...
  * Fixes [#1334](https://github.com/journeymidnight/aws-sdk-go/pull/1334)
...
### SDK Bugs
* `aws/request`: Fix NewErrParamMinLen to use correct ParamMinLenErrCode [#1336](https://github.com/journeymidnight/aws-sdk-go/issues/1336)
  ...
  * Fixes [#1335](https://github.com/journeymidnight/aws-sdk-go/issues/1335)
...
### SDK Enhancements
* `aws/defaults`: Exports shared credentials and config default filenames used by the SDK. [#1308](https://github.com/journeymidnight/aws-sdk-go/pull/1308)
  * Adds SharedCredentialsFilename and SharedConfigFilename functions to defaults package.

### SDK Bugs
* `aws/credentials`: Fixes shared credential provider's default filename on Windows. [#1308](https://github.com/journeymidnight/aws-sdk-go/pull/1308)
...
* `service/s3/s3manager`: service/s3/s3manager: Fix Downloader ignoring Range get parameter [#1311](https://github.com/journeymidnight/aws-sdk-go/pull/1311)
  ...
  * Fixes [#1296](https://github.com/journeymidnight/aws-sdk-go/issues/1296)
...
### SDK Bugs
* `aws/request`: Add support for PUT temporary redirects (307) [#1283](https://github.com/journeymidnight/aws-sdk-go/issues/1283)
  ...
  * Fixes: [#1267](https://github.com/journeymidnight/aws-sdk-go/issues/1267)
* `aws/request`: Add handling for retrying temporary errors during unmarshal [#1289](https://github.com/journeymidnight/aws-sdk-go/issues/1289)
  * Adds support for retrying temporary errors that occur during unmarshaling of a request's response body.
  * Fixes: [#1275](https://github.com/journeymidnight/aws-sdk-go/issues/1275)
...
### SDK Enhancements
* `aws/session`: SDK should be able to load multiple custom shared config files. [#1258](https://github.com/journeymidnight/aws-sdk-go/issues/1258)
...
into tagged fields 
[#916](https://github.com/journeymidnight/aws-sdk-go/issues/916)
...
SDK Features
---
* `service/s3`: Add support for accelerate with dualstack [#887](https://github.com/journeymidnight/aws-sdk-go/issues/887)
...
SDK Bug Fixes
---
* `aws/session`: Skip shared config on read errors [#883](https://github.com/journeymidnight/aws-sdk-go/issues/883)
* `aws/signer/v4`: Add support for URL.EscapedPath to signer [#885](https://github.com/journeymidnight/aws-sdk-go/issues/885)

SDK Features
---
* `private/model/api`: Add docs for errors to API operations [#881](https://github.com/journeymidnight/aws-sdk-go/issues/881)
* `private/model/api`: Improve field and waiter doc strings [#879](https://github.com/journeymidnight/aws-sdk-go/issues/879)
* `service/dynamodb/dynamodbattribute`: Allow multiple struct tag elements [#886](https://github.com/journeymidnight/aws-sdk-go/issues/886)
* Add build tags to internal SDK tools [#880](https://github.com/journeymidnight/aws-sdk-go/issues/880)
...
SDK Bug Fixes
---
* `aws/request`: Fix HTTP Request Body race condition [#874](https://github.com/journeymidnight/aws-sdk-go/issues/874)

SDK Feature Updates
---
* `aws/ec2metadata`: Add support for EC2 User Data [#872](https://github.com/journeymidnight/aws-sdk-go/issues/872)
* `aws/signer/v4`: Remove logic determining if request needs to be resigned [#876](https://github.com/journeymidnight/aws-sdk-go/issues/876)
